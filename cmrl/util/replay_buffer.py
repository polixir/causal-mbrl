...
class ReplayBuffer:
    ...
    def sample(self, batch_size: int) -> InteractionBatch:
    ...
    def sample_trajectory(self) -> Optional[InteractionBatch]:
    ...
    def _batch_from_indices(self, indices: Sized) -> InteractionBatch:
        ...
        return InteractionBatch(obs, action, next_obs, reward, done)
    ...
    def get_all(self, shuffle: bool = False) -> InteractionBatch:
