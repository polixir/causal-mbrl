...
class MetersGroup(object):
    def __init__(self,
        ...
        self._tb_index_key = tb_index_key if tb_index_key is not None else "step"

        self._disable_console_dump = disable_console_dump
    ...
    def dump(self, step: int, prefix: str, save: bool = True, color: str = "yellow"):
        ...
        if save:
            ...
            # dump to console
            if not self._disable_console_dump:
...
class Logger(object):
    ...
    def register_group(
        ...
        Args:
            ...
            disable_console_dump (bool): silent
            tb_index_key (str): index key for tensorboard
